...
CORS(app)  # Allows JavaScript fetches without browser security blocking
...
def generate():
    # Receive data directly from JavaScript JSON fetch payload
    ...
    if interest == "Tech":
        if level == "Beginner":
            ...
            if problem == "Confusion": roadmap_30.append("Do not decide career yet, just explore")
            elif problem == "Discipline": roadmap_30.append("Fix a daily learning time and follow it")
            elif problem == "Resources": roadmap_30.append("Use only free tools and platforms")
            if age_group == "under18": roadmap_30.append("Focus on learning, not earning")
            else: roadmap_12.append("Prepare for internships, freelancing, or jobs")
    ...
    # ================= CREATIVE =================
        ...
        if level == "Beginner":
            ...
            if problem == "Confusion": roadmap_30.append("Experiment without pressure")
            elif problem == "Discipline": roadmap_30.append("Fix a daily creative routine")
            elif problem == "Resources": roadmap_30.append("Use only free tools")
        elif level == "Intermediate":
    ...
    # Clean return of pure data over an API channel
    return jsonify({
